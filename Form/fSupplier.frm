...
On Error GoTo aa
'Set aSet = aData.AmbilData("SELECT Supplier.Kode, Supplier.Nama, Supplier.Alamat, Supplier.Kota, Supplier.Telepon, Supplier.[Credit Limit],[Lebih Bayar] FROM Supplier;")
Set aSet = aData.AmbilData("SELECT Supplier.Kode, Supplier.Nama, Supplier.Alamat, " & _
"Supplier.[Wilayah], Supplier.[Lama Credit], " & _
"Supplier.Kota, Supplier.Telepon, Supplier.Ket, " & _
"Supplier.[Lebih Bayar], [Inpututang Query].[Sum Of Sisa] as [Jumlah Utang] FROM Supplier left JOIN [InputUtang Query] ON Supplier.Kode = [Inpututang Query].Kepada;")
Grid.DataSource = aSet
'Supplier.[Credit Limit],Supplier.[Lama Credit],
Exit Sub
aa:
...
On Error GoTo aa
Grid.Columns(0).Width = 1500
Grid.Columns(1).Width = 2500
Grid.Columns(2).Width = 3500
...
For i = 1 To oRS2.RecordCount
  Oi.Value = oRS2!Kode
  Oi.DisplayValue = oRS2!Nama
  Grid.Columns(3).ValueItems.Add Oi
  oRS2.MoveNext
Next i
...
'Grid.Columns(4).Width = 800: Grid.Columns(4).Alignment = dbgRight
'Grid.Columns(5).Width = 600: Grid.Columns(5).Alignment = dbgRight
'Grid.Columns(4).Width = 800
Grid.Columns(5).Width = 1500
Grid.Columns(6).Width = 1500
Grid.Columns(7).Width = 3500
Grid.Columns(8).Width = 1200
Grid.Columns(9).Width = 1200
Grid.Columns(8).Locked = True
Grid.Columns(9).Locked = True
Grid.Columns(9).NumberFormat = "Standard"
Grid.HeadLines = 2.5
Grid.Font.Bold = True
Grid.Font.Size = 10
Exit Sub
