...
On Error GoTo aa
Set aSet = aData.AmbilData("SELECT Barang.[Kode Barang], Barang.[Nama Barang], Barang.Qty, Satuan, Barang.[Qty Satuan Kecil], Barang.[Satuan Kecil], Barang.[Tipe], Barang.[Qty Min], Barang.[Harga Beli], Barang.[Harga Jual] FROM Barang;")
...
Grid.Columns(2).Width = 750
Grid.Columns(3).Width = 1000
Grid.Columns(4).Width = 1300
Grid.Columns(5).Width = 1000
Grid.Columns(6).Width = 1500
Grid.Columns(7).Width = 750
Grid.Columns(8).Width = 1500
Grid.Columns(9).Width = 1500
Grid.Columns(2).Locked = True

Dim oRS2 As New ADODB.Recordset
Set oRS2 = aData.AmbilData("SELECT * from Tipe;")
Dim i As Integer, Oi As New ValueItem
For i = 1 To oRS2.RecordCount
  Oi.Value = oRS2!Kode
  Oi.DisplayValue = oRS2!Nama
  Grid.Columns(6).ValueItems.Add Oi
  oRS2.MoveNext
Next i
Grid.Columns(6).AutoCompletion = True
Grid.Columns(6).AutoDropDown = True
Grid.Columns(6).ValueItems.Translate = True
Grid.Columns(6).ValueItems.Presentation = dbgComboBox
